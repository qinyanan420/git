...
#前端公告板转中文
    sc = '''
{4,2,0,1},{1,7,0,1},{1,3,0,1},{1,2,0,1},{1,1,0,3}
{4,2,0,1},{1,7,0,1},{1,3,0,1},{1,2,0,1},{1,1,0,3}
{4,2,0,1},{1,7,0,1},{1,3,0,1},{1,2,0,3},{1,1,0,2}
{4,2,0,1},{1,7,0,1},{1,3,0,1},{1,2,0,3},{1,1,0,2}
{4,2,0,1},{1,8,0,1},{1,3,0,3},{1,2,0,1},{1,1,0,2}
{4,2,0,1},{1,8,0,1},{1,3,0,3},{1,2,0,2},{1,1,0,2}
{4,2,0,1},{1,8,0,1},{1,4,0,1},{1,3,0,2},{1,2,0,3}
{4,2,0,1},{1,8,0,1},{1,4,0,1},{1,3,0,3},{1,2,0,1}
{4,2,0,1},{1,8,0,1},{1,4,1,1},{1,4,0,1},{1,3,0,2},{1,2,0,2}
{4,2,0,1},{1,8,0,1},{1,4,1,1},{1,4,0,1},{1,3,0,2},{1,2,0,2}
'''

#前端奖励转中文
    sr = '''
{{1,1,1},{1,1,1},{1,1,2},{1,1,3},{1,2,3},{1,4,3}},
    {{1,1,1},{1,1,1},{1,1,2},{1,1,3},{1,2,3},{1,4,3}},
    {{1,1,1},{1,1,2},{1,1,2},{1,1,3},{1,2,3},{1,4,3}},
    {{1,1,2},{1,1,2},{1,1,2},{1,1,3},{1,2,3},{1,4,3}},
    {{1,1,2},{1,1,2},{1,1,3},{1,1,3},{1,2,3},{1,4,3}},
    {{1,1,2},{1,1,3},{1,1,3},{1,1,4},{1,2,3},{1,4,3}},
    {{1,1,2},{1,1,3},{1,1,3},{1,1,4},{1,2,3},{1,4,3}},
    {{1,1,3},{1,1,3},{1,1,3},{1,1,4},{1,2,3},{1,4,3}},
    {{1,1,3},{1,1,3},{1,1,4},{1,1,4},{1,2,3},{1,4,3}},
    {{1,1,3},{1,1,3},{1,1,4},{1,1,4},{1,2,3},{1,4,3}},
