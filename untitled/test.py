...
#产品横文案转竖文案
    sj = '''
铜	铜	银	金	3星Treasure卡	3星legend卡
铜	铜	银	金	3星Treasure卡	3星legend卡
铜	银	银	金	3星Treasure卡	3星legend卡
银	银	银	金	3星Treasure卡	3星legend卡
银	银	金	金	3星Treasure卡	3星legend卡
银	金	金	钻石	3星Treasure卡	3星legend卡
银	金	金	钻石	3星Treasure卡	3星legend卡
金	金	金	钻石	3星Treasure卡	3星legend卡
金	金	钻石	钻石	3星Treasure卡	3星legend卡
金	金	钻石	钻石	3星Treasure卡	3星legend卡
'''

#前端公告板转中文
    sc = '''
{4,1,0,1},{1,7,0,1},{2,3,0,1},{3,3,0,1},{1,3,0,1},{1,2,0,1},{1,1,0,2},
{4,1,0,1},{1,7,0,1},{2,3,0,1},{3,3,0,1},{1,3,0,1},{1,2,0,1},{1,1,0,2},
        {4,1,0,1},{1,7,0,1},{2,3,0,1},{3,3,0,1},{1,3,0,1},{1,2,0,2},{1,1,0,1},
        {4,1,0,1},{1,7,0,1},{2,3,0,1},{3,3,0,1},{1,3,0,1},{1,2,0,3},
        {4,1,0,1},{1,8,0,1},{2,3,0,1},{3,3,0,1},{1,3,0,2},{1,2,0,2},
        {4,1,0,1},{1,8,0,1},{2,3,0,1},{3,3,0,1},{1,4,0,1},{1,3,0,2},{1,2,0,1},
        {4,1,0,1},{1,8,0,1},{2,3,0,1},{3,3,0,1},{1,4,0,1},{1,3,0,2},{1,2,0,1},
        {4,1,0,1},{1,8,0,1},{2,3,0,1},{3,3,0,1},{1,4,0,1},{1,3,0,3},
        {4,1,0,1},{1,8,0,1},{2,3,0,1},{3,3,0,1},{1,4,0,2},{1,3,0,2},
        {4,1,0,1},{1,8,0,1},{2,3,0,1},{3,3,0,1},{1,4,0,2},{1,3,0,2}
'''
...
#后端代码转化文字
    sh = '''
GARDEN_REWARD_COMPLETE_CARD = [
    [GARDEN_REWARD_LEGEND3_CHEST, 1],
    [GARDEN_REWARD_LEGEND3_CHEST, 1],
    [GARDEN_REWARD_LEGEND3_CHEST, 1],
    [GARDEN_REWARD_LEGEND3_CHEST, 1],
    [GARDEN_REWARD_LEGEND4_CHEST, 1],
    [GARDEN_REWARD_LEGEND4_CHEST, 1],
    [GARDEN_REWARD_LEGEND4_CHEST, 1],
    [GARDEN_REWARD_LEGEND4_CHEST, 1],
    [GARDEN_REWARD_LEGEND4_CHEST, 1],
